...
using CarMaintainer.Models.AccountViewModels;
using CarMaintainer.Services;
...
namespace CarMaintainer.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public object StaticDynamic { get; private set; }
        ...
        public async Task<IActionResult> Register(RegisterViewModel model, string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    {
                        return RedirectToAction("Users", "Service type", new { userId = user.Id });
                    }
                    else
                    {
